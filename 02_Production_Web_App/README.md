...
```bash
cd Loan-Approval-App/03_Native_Mobile_App
...
* **Web Service:** Deployed on **Render** linked to `main` branch (`uvicorn main:app --host 0.0.0.0 --port $PORT`).
* **Mobile Releases:** Binary builds hosted on [GitHub Releases](https://github.com/YashkumarBhatt/Loan-Approval-App/releases).
